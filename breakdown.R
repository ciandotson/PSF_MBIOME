...
option_list <- list(
  ...
  make_option("--raw_roots", type = "character", help = "filepath containing the raw, untrimmed reads for the reads generated from the v5-v7 primers( root endosphere and some nodule samples)"),
